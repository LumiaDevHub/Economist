...
public class ManagerAPI implements EconomistAPI {

    static FileConfiguration c = getPlugin().getConfig();
    static FileConfiguration m = getPlugin().getMessages();

    @Override
    public void haveAccount(Player p, Consumer<Boolean> callback) {
    ...
    @Override
    public void getAccount(Player p, Consumer<String> callback) {
        Bukkit.getScheduler().runTaskAsynchronously(getPlugin(), () -> {
            String name = "";
    ...
    @Override
    public void getPinCode(Player p, Consumer<Integer> callback) {
        Bukkit.getScheduler().runTaskAsynchronously(getPlugin(), () -> {
            haveAccount(p, (call) -> {
                if (!call) {
    ...
    @Override
    public void createAccount(Player p, String name, int pin) {
        haveAccount(p, (call) -> {
            if(call) {
